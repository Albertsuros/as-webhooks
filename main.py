...
# AÑADIR ESTAS FUNCIONES A main.py para ver el HTML directamente

@app.route('/test/ver_html_carta_astral/<especialidad>')
...
@app.route('/test/ver_html_con_cartas_reales')
def ver_html_con_cartas_reales():
    ...
    try:
        ...
        # USAR CARTAS REALES que YA funcionan (de las URLs anteriores)
        archivos_reales = {
        ...
        if archivo_html and os.path.exists(archivo_html):
            # Leer HTML y modificar rutas para que funcionen en browser
            with open(archivo_html, 'r', encoding='utf-8') as f:
                html_content = f.read()
            
            # Las URLs HTTP ya están bien, servir directo
            return html_content
        else:
...
@app.route('/test/lista_archivos_html_generados')
def lista_archivos_html_generados():
    ...
    try:
        ...
        <body>
            ...
            <p>Estos son todos los archivos HTML que se han generado. Haz clic en "Ver" para abrir cada uno en el browser.</p>
        """
        ...
        if lista_archivos:
            ...
            html_response += "<p><em>No se encontraron archivos HTML generados.</em></p>"
        ...
        html_response += """
            ...
            <ul>
                ...
                <li><a href="/test/ver_html_carta_astral/carta_astral_ia" target="_blank">Generar nuevo HTML carta astral</a></li>
                <li><a href="/test/ver_html_carta_astral/sinastria_ia" target="_blank">Generar nuevo HTML sinastría</a></li>
            </ul>
        </body>
        </html>
        """
...
@app.route('/test/ver_archivo_html/<nombre_archivo>')
